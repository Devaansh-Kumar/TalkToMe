  ...
  return (
    <>
      <div className="pt-5 pb-8 bg-gray-200">
        <h2 className="flex font-sans justify-center font-bold text-5xl mt-7 mb-5">
          About
        </h2>
        <div className="flex max-w-2xl mx-auto justify-center text-center text-sm py-2 text-zinc-500">
          This Project was made for the Google Cloud Vertex AI Hackathon held by
          Lab Lab AI.
        </div>
        <div className="flex max-w-md mx-auto justify-center text-center py-4">
          We are a highly enthusiastic team of 5 students from National
          Institute of Technology, Karnataka who have come together with a
          common goal of building innovative products that push the boundaries
          of what's possible.
        </div>
      </div>
      <div className="my-16">
        <div className="flex justify-center font-bold text-4xl my-5">
          Tech Stack
        </div>
