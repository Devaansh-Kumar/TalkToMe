...
const AboutUs = () => {
  return (
    ...
    <div className="pt-5 pb-8 bg-gray-200">
      <h2 className="flex font-sans justify-center font-bold text-3xl mt-7 mb-5">About</h2>
      <div className="flex max-w-xl mx-auto justify-center text-center py-2">
        This Project was made for the Google Cloud Vertex AI Hackathon held by Lab Lab AI.
      </div>
      <div className="flex max-w-2xl mx-auto justify-center text-center py-4">
    ...
    <div className="my-16">
        <div className="flex justify-center font-bold text-2xl my-5">Tech Stack</div>
        <div className="flex flex-row max-w-3xl justify-between mx-auto mb-5">
          ...
          <img className="w-28" src="/palm.jpeg"/>
        </div>
      </div>
      <div className="flex justify-center font-bold text-2xl mt-12 mb-3">The Team</div>
