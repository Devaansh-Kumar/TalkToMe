...
<nav className="bg-white dark:bg-gray-900 w-full z-20 fixed left-0 top-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <div className="flex md:order-2">
      {currentUser? <>
        <img class="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500 mx-2" src={currentUser.profile_pic} alt="Bordered avatar"/>
        <SignOut/>
      </>
        : <GoogleAuthBtn/>}
...
{   currentUser && (
  <NavItem path="/dashboard" name="Dashboard"/>
      ...
      <NavItem path="https://github.com/Devaansh-Kumar/TalkToMe/" name="Github" target="_blank"/>
    </ul>
  </div>
  </div>
</nav>
